...
foreach ($allfiles as $file) {
    if (strstr($file, '.txt')) {
        ...
        if ($ilk_silis == 1) {
            delete_generic("hwtable", NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            $ilk_silis = 0;
        }

        if (get_generic2("hwtable", $cluster_name, "node_name", $node_name, "category", "hw_ref_diskmaxMBs", NULL, NULL, $category) == "yok") {
            insert_hwtable($cluster_name, $report_time, $node_name, "hw_ref_diskmaxMBs", 0, "hw_id");
            insert_hwtable($cluster_name, $report_time, $node_name, "hw_ref_homemaxMbs", 0, "hw_id");
        }
